...
const AddContact = () => {
    ...
    <>
        ...
        <div className="w-full bg-[#909296] p-2 rounded">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text"
                                    ...
                                    name="name" 
                                    value={formData.name}
                                    className="rounded-sm focus:outline-none focus:border-2 focus:border-[#6a98ee] "
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text"
                                    ...
                                    name="suite"
                                    value={address.suite}
                                    className="rounded-sm focus:outline-none focus:border-2 focus:border-[#ebeefa]"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text"
                                    ...
                                    name="city"
                                    value={address.city}
                                    className="rounded-sm focus:outline-none focus:border-2 focus:border-[#c2d0fc] "
                                    onChange={handleAddressChange}
                                    required />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text"
                                    ...
                                    className="rounded-sm focus:outline-none focus:border-2 focus:border-[#bbc7f0] "
                                    onChange={handleAddressChange}
                                    required />
                            </td>
                        </tr>
